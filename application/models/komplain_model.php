...
*/
    ...
    {
        $sql = "INSERT INTO KOMPLAIN (NAMA_MEDIA, NAMA_LAYANAN, JENIS_KOMPLAIN, TGL_KOMPLAIN, TGL_CLOSE, KELUHAN, SOLUSI, STATUS_KOMPLAIN, KETERANGAN, NO_POTS, NO_INTERNET, NAMA_PELAPOR, ALAMAT_PELAPOR, PIC_PELAPOR, DEADLINE) VALUES ('$NAMA_MEDIA', '$NAMA_LAYANAN', '$JENIS_KOMPLAIN', STR_TO_DATE('$TGL_KOMPLAIN','%d/%m/%Y %T'), STR_TO_DATE('$TGL_CLOSE','%d/%m/%Y'), '$KELUHAN', '$SOLUSI', '$STATUS_KOMPLAIN', '$KETERANGAN', '$NO_POTS', '$NO_INTERNET', '$NAMA_PELAPOR', '$ALAMAT_PELAPOR', '$PIC_PELAPOR', STR_TO_DATE('$DEADLINE','%d/%m/%Y %T'))";
        return $this->db->query($sql);
