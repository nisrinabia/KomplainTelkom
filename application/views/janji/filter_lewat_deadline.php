    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-body">
              <h4>Navigasi</h4><hr>
                ...
                <div class="pull-right"><a href="<?php echo base_url() ?>janji/lewat_deadline"> <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Kembali ke daftar semua janji melewati deadline">Kembali</button></a>
              </div>
              <br><br>
              <h4>Filter</h4><hr>
        ...
        <div class="box">
          ...
          if($list != NULL)
          {
            echo '<a href="'.base_url().'janji/excelFilter/past/'.$bulan.'/'.$tahun.'"><button type="button" class="btn btn-primary">Unduh file excel</button></a>';
          }
          ?>
