    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-body">
              <h4>Navigasi</h4><hr>
                ...
                <div class="pull-right"><a href="<?php echo base_url() ?>janji/lewat_deadline"> <button type="button" class="btn btn-primary">Kembali</button></a>
              </div>
              <br><br>
              <h4>Filter</h4><hr>
        ...
        <div class="box">
          ...
          <div class="box-body">
          <a href="<?php echo ''.base_url().'janji/excelFilter/past/'.$bulan.'/'.$tahun.''?>"><button type="button" class="btn btn-primary">Unduh file excel</button></a>
                  ...
                  { 
                    ...
                    <tr>
                      <th style="background-color:#F2D9CB!important">
                        ...
                        <a href="<?php echo base_url() . 'janji/deleteWhenFilter/' . $row->ID_KOMPLAIN . '?mode=past&bulan=' . $bulan . '&tahun=' . $tahun?>" title="Hapus" onclick="return deldata()"><i class="fa fa-trash text-black"></i></a>
                      </th>
