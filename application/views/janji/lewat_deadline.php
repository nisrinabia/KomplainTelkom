                  ...
                  { 
                    ...
                    <tr>
                      <th style="background-color:#F2D9CB!important">
                        ...
                        <a href="<?php echo base_url() . 'janji/delete/' . $row->ID_KOMPLAIN ?>?mode=past" data-toggle="tooltip" data-placement="top" title="Hapus" onclick="return deldata()"><i class="fa fa-trash text-black fa-lg"></i></a>
                      </th>
